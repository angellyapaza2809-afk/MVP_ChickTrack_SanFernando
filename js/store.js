...
const UBICACION_POR_DESTINO = {
  ...
  "Granja Chincha Alta": { codigoPlantel: "280", zona: "Zona Sur", subzona: "Chincha", circuito: "Circuito 3", tipoPlantel: "Engorde", supervisor: "Carla Núñez Vidal", coordinador: "Renzo Ortega Lam", franquicia: "San Fernando" },
  "Granja Pisco": { codigoPlantel: "281", zona: "Zona Sur", subzona: "Pisco", circuito: "Circuito 5", tipoPlantel: "Recría", supervisor: "Milagros Chávez Ríos", coordinador: "Renzo Ortega Lam", franquicia: "San Fernando" },
  "Granja Barranca": { codigoPlantel: "156", zona: "Zona Norte Chico", subzona: "Barranca", circuito: "Circuito 1", tipoPlantel: "Engorde", supervisor: "Ana Belén Castro", coordinador: "Diego Herrera Paz", franquicia: "San Fernando" },
  "Granja Supe": { codigoPlantel: "220", zona: "Zona Norte Chico", subzona: "Supe", circuito: "Circuito 1", tipoPlantel: "Recría", supervisor: "Fiorella Ramos Ibáñez", coordinador: "Diego Herrera Paz", franquicia: "San Fernando" },
  "Granja Cañete Norte": { codigoPlantel: "195", zona: "Zona Sur", subzona: "Cañete", circuito: "Circuito 2", tipoPlantel: "Recría", supervisor: "Jorge Medina Ruiz", coordinador: "Renzo Ortega Lam", franquicia: "San Fernando" },
  "Granja Chancay Valle": { codigoPlantel: "300", zona: "Zona Norte Chico", subzona: "Chancay", circuito: "Circuito 1", tipoPlantel: "Engorde", supervisor: "Iván Salcedo Bravo", coordinador: "Diego Herrera Paz", franquicia: "San Fernando" },
};
...
function seedData() {
  ...
  const base = [
    ...
    // --- Más historial + más planteles, para dar volumen y variedad a
    // BI, Portal Plantel y los selectores de fecha/destino. ---
    {
      dtSap: "0080012356",
      ruta: "R-040",
      planta: "Planta Chancay",
      destino1: "Granja Barranca",
      destino2: "",
      destino3: "",
      cantidad: 20000,
      edadLotes: "Lote 234-A",
      galpon: "G-04",
      puntoCarga: "Andén 1",
      unidad: "T-140",
      placa: "F1Z-905",
      conductor: "Karina Espinoza Del Río",
      horaSalidaPlan: "05:40",
      horaCargaFinPlan: "06:00",
      esperaMaxMin: 20,
      horaRetornoPlan: "09:15",
      plantaRetorno: "Planta Chancay",
      estado: "Finalizado",
      horaSalidaReal: "05:42",
      horaLlegadaReal: "07:20",
      diasOffset: -3,
    },
    {
      dtSap: "0080012357",
      ruta: "R-041",
      planta: "Planta Chancay",
      destino1: "Granja Supe",
      destino2: "",
      destino3: "",
      cantidad: 15500,
      edadLotes: "Lote 234-B",
      galpon: "G-02",
      puntoCarga: "Andén 2",
      unidad: "T-155",
      placa: "F9C-330",
      conductor: "Ronald Quispe Farfán",
      horaSalidaPlan: "06:10",
      horaCargaFinPlan: "06:30",
      esperaMaxMin: 20,
      horaRetornoPlan: "10:00",
      plantaRetorno: "Planta Chancay",
      estado: "Finalizado",
      horaSalidaReal: "06:12",
    ...
    },
    {
      ...
      ruta: "R-050",
      planta: "Planta Chincha",
      destino1: "Granja Chincha Alta",
      destino2: "",
      destino3: "",
      cantidad: 22500,
      edadLotes: "Lote 234-C",
      galpon: "G-06",
      puntoCarga: "Andén 3",
      unidad: "T-188",
      placa: "F7Q-102",
      conductor: "Diego Alonso Vega",
      horaSalidaPlan: "05:25",
      horaCargaFinPlan: "05:45",
      esperaMaxMin: 25,
      horaRetornoPlan: "09:00",
      plantaRetorno: "Planta Chincha",
      estado: "Finalizado",
      horaSalidaReal: "05:27",
      horaLlegadaReal: "07:15",
      diasOffset: -4,
    },
    {
      dtSap: "0080012359",
      ruta: "R-051",
      planta: "Planta Chincha",
      destino1: "Granja Pisco",
      destino2: "",
      destino3: "",
      cantidad: 19000,
      edadLotes: "Lote 234-D",
      galpon: "G-01",
      puntoCarga: "Andén 4",
      unidad: "T-045",
      placa: "F2K-509",
      ...
      plantaRetorno: "Planta Chincha",
      estado: "Finalizado",
      horaSalidaReal: "05:04",
      horaLlegadaReal: "07:50",
      diasOffset: -4,
    },
    {
      dtSap: "0080012360",
      ruta: "R-021",
      planta: "Planta Mala",
      destino1: "Granja Cañete Norte",
      destino2: "",
      destino3: "",
      cantidad: 17800,
      edadLotes: "Lote 234-E",
      galpon: "G-07",
      puntoCarga: "Andén 1",
      unidad: "T-092",
      placa: "F6Y-233",
      conductor: "Marco Antonio Flores",
      horaSalidaPlan: "06:15",
      horaCargaFinPlan: "06:35",
      esperaMaxMin: 20,
      horaRetornoPlan: "10:10",
      plantaRetorno: "Planta Mala",
      estado: "Finalizado",
      horaSalidaReal: "06:18",
    ...
    },
    {
      ...
      ruta: "R-030",
      planta: "Planta Chancay",
      destino1: "Granja Chancay Valle",
      destino2: "",
      destino3: "",
      cantidad: 24800,
      edadLotes: "Lote 234-F",
      galpon: "G-03",
      puntoCarga: "Andén 2",
      unidad: "T-101",
      placa: "F8L-671",
      conductor: "Eduardo Salas Chávez",
      horaSalidaPlan: "06:50",
      horaCargaFinPlan: "07:10",
      esperaMaxMin: 20,
      horaRetornoPlan: "10:30",
      plantaRetorno: "Planta Chancay",
      estado: "Finalizado",
      horaSalidaReal: "06:53",
      horaLlegadaReal: "08:40",
      diasOffset: -5,
    },
    {
      dtSap: "0080012362",
      ...
      plantaRetorno: "Planta Mala",
      estado: "Finalizado",
      horaSalidaReal: "05:33",
      horaLlegadaReal: "07:44",
      diasOffset: -6,
    },
    {
      dtSap: "0080012363",
      ...
      plantaRetorno: "Planta Mala",
      estado: "Finalizado",
      horaSalidaReal: "05:47",
      horaLlegadaReal: "08:01",
      diasOffset: -6,
    },
    {
      dtSap: "0080012364",
      ...
      plantaRetorno: "Planta Chincha",
      estado: "Finalizado",
      horaSalidaReal: "05:02",
      horaLlegadaReal: "07:26",
      diasOffset: -7,
    },
    {
      dtSap: "0080012365",
      ...
      plantaRetorno: "Planta Chincha",
      estado: "Finalizado",
      horaSalidaReal: "05:28",
      horaLlegadaReal: "07:18",
      diasOffset: -7,
    },
    // --- Viajes de hoy/mañana en distintos estados en curso, para que
    // los módulos operativos (planta/tránsito/granja) tengan variedad
    // de unidades en más de un plantel a la vez. ---
    {
      dtSap: "0080012366",
      ruta: "R-041",
      planta: "Planta Chancay",
      ...
      destino3: "",
      cantidad: 16200,
      edadLotes: "Lote 234-G",
      galpon: "G-02",
      puntoCarga: "Andén 2",
      unidad: "T-155",
      placa: "F9C-330",
      conductor: "Ronald Quispe Farfán",
      horaSalidaPlan: "06:20",
      horaCargaFinPlan: "06:40",
      esperaMaxMin: 20,
      horaRetornoPlan: "10:10",
      plantaRetorno: "Planta Chancay",
      estado: "En Tránsito",
      horaSalidaReal: "06:24",
      horaLlegadaReal: "",
      diasOffset: 0,
    },
    {
      ...
      destino3: "",
      cantidad: 18700,
      edadLotes: "Lote 234-H",
      galpon: "G-01",
      puntoCarga: "Andén 4",
      unidad: "T-045",
      placa: "F2K-509",
      conductor: "Luis Alberto Peña",
      horaSalidaPlan: "05:50",
      horaCargaFinPlan: "06:10",
      esperaMaxMin: 30,
      horaRetornoPlan: "10:30",
      plantaRetorno: "Planta Chincha",
      estado: "En Carga",
    ...
    },
    {
      ...
      destino3: "",
      cantidad: 17100,
      edadLotes: "Lote 234-I",
      galpon: "G-07",
      puntoCarga: "Andén 1",
      unidad: "T-092",
      placa: "F6Y-233",
      conductor: "Marco Antonio Flores",
      horaSalidaPlan: "07:10",
      horaCargaFinPlan: "07:30",
      esperaMaxMin: 20,
      horaRetornoPlan: "11:00",
      plantaRetorno: "Planta Mala",
      estado: "Programado",
      horaSalidaReal: "",
      horaLlegadaReal: "",
    ...
    },
    {
      ...
      destino3: "",
      cantidad: 25200,
      edadLotes: "Lote 234-J",
      galpon: "G-03",
      puntoCarga: "Andén 2",
      unidad: "T-101",
      placa: "F8L-671",
      conductor: "Eduardo Salas Chávez",
      horaSalidaPlan: "06:55",
      horaCargaFinPlan: "07:15",
      esperaMaxMin: 20,
      horaRetornoPlan: "10:35",
      plantaRetorno: "Planta Chancay",
      estado: "En Granja",
      horaSalidaReal: "06:57",
      horaLlegadaReal: "08:50",
      diasOffset: 0,
    },
    // --- Segundo viaje multi-plantel: reparte en 2 granjas distintas. ---
    {
      dtSap: "0080012370",
      ruta: "R-060",
      planta: "Planta Chincha",
      destino1: "Granja Pisco",
      destino2: "Granja Chincha Alta",
      destino3: "",
      cantidad: 27500,
      edadLotes: "Lote 233-H",
      galpon: "G-01",
      galpon2: "G-06",
      puntoCarga: "Andén 3",
      unidad: "T-188",
      ...
      horaCargaFinPlan: "05:40",
      esperaMaxMin: 30,
      horaRetornoPlan: "09:50",
      plantaRetorno: "Planta Chincha",
      estado: "Finalizado",
      horaSalidaReal: "05:18",
      horaLlegadaReal: "07:35",
      diasOffset: -2,
    },
  ];
  ...
  const viajes = base.map((v, i) => {
    ...
    if (["En Granja", "Finalizado"].includes(v.estado)) {
      ...
      // Calificación del plantel (Portal Plantel) — ya cargada en la
      // mayoría de los pedidos entregados, para que el portal no se vea
      // vacío; se deja 1 de cada 4 sin calificar para mostrar el formulario.
      if (v.estado === "Finalizado" && i % 4 !== 0) {
        const FEEDBACK_POOL = [
          { nps: 9, conformidad: "conforme", comentario: "Llegó puntual y en buen estado. Excelente coordinación." },
          { nps: 10, conformidad: "conforme", comentario: "Todo conforme, temperatura y mortalidad dentro de rango." },
          { nps: 6, conformidad: "observaciones", comentario: "Llegó con algo de retraso, pero el lote llegó bien." },
          { nps: 8, conformidad: "conforme", comentario: "" },
          { nps: 4, conformidad: "no_conforme", comentario: "Mortalidad más alta de lo esperado en este lote." },
          { nps: 9, conformidad: "conforme", comentario: "Buen servicio, como siempre." },
        ];
        granja.feedback = { ...FEEDBACK_POOL[i % FEEDBACK_POOL.length], fecha: f };
      }
    }
...
function seedChecklists() {
  ...
  const cl7 = {
    plantel: "Granja Barranca",
    galpon: "G-04",
    fecha: fechaISO(-3),
    auditor: "Milagros Chávez Ríos",
    supervisor: UBICACION_POR_DESTINO["Granja Barranca"].supervisor,
    firma: "Milagros Chávez Ríos",
    selecciones: construirSelecciones([3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]),
  };

  const cl8 = {
    plantel: "Granja Chincha Alta",
    galpon: "G-06",
    fecha: fechaISO(-4),
    auditor: "Iván Salcedo Bravo",
    supervisor: UBICACION_POR_DESTINO["Granja Chincha Alta"].supervisor,
    firma: "Iván Salcedo Bravo",
    selecciones: construirSelecciones(
      [2, 3, 2, 3, 2, 3, 2, 2, 1, 3, 3, 2, 3, 0, 2, 2, 2],
      { 13: "Solo 3 de 8 filas de papel Kraft disponibles; se refuerza antes de la recepción." }
    ),
  };

  const cl9 = {
    plantel: "Granja Chancay Valle",
    galpon: "G-03",
    fecha: fechaISO(-5),
    auditor: "Fiorella Ramos Ibáñez",
    supervisor: UBICACION_POR_DESTINO["Granja Chancay Valle"].supervisor,
    firma: "Fiorella Ramos Ibáñez",
    selecciones: construirSelecciones([3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]),
  };

  // Nota: "Granja Huaral · G-99" (3er galpón del viaje multi-galpón
  // 0080012355), "Granja Supe · G-02" y "Granja Pisco · G-01" quedan
  // deliberadamente sin checklist, para seguir mostrando el estado
  // "Sin checklist" en algunos planteles/galpones de la demo.

  [cl1, cl2, cl3, cl4, cl5, cl6, cl7, cl8, cl9].forEach((cl) => {
